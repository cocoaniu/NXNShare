...
NSString *const  kCellIdentifier_NXNShareItemCell = @"NXNShareItemCell";

@interface NXNShareItemCell()
...
@implementation NXNShareItemCell
...
- (void)setShareItem:(NXNShareItem *)shareItem{
    _shareItem = shareItem;
    _imageView.image = [UIImage imageNamed:[@"NXNShareImage.bundle" stringByAppendingPathComponent:shareItem.imageName]];
...
- (void)layoutSubviews{
    ...
    _imageView.frame = CGRectMake((_itemImageSize.width - 48) / 2, (_itemImageSize.height - 48) / 2 , 48, 48);
